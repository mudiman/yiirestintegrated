...
class WorkersController extends Controller
{
	...
	public $layout='//layouts/column1';
        ...
        public function init(){
            $this->menu=array(
                array('label'=>'Add Technician', 'url'=>array('./users/createtechnician')),
                array('label'=>'Assign Technician to Salon', 'url'=>array('create')),
                array('label'=>'List Workers', 'url'=>array('list')),
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Workers']))
			$model->attributes=$_GET['Workers'];
                $dataProvider = new CActiveDataProvider('Workers', array(
                    'criteria' => array(
                        'condition' => "providers_id in (select providers_id from workers where users_id=".Yii::app()->user->id.")",
                        'order' => 'id'
                    ), 'pagination' => array(
                        'pageSize' => 10,
                    )
